...
import com.example.myapplicationauth.models.SystemData;
import com.example.myapplicationauth.models.User;
    ...
    private void checkEmailVerification() {
        ...
        if (loggedUser != null) {
            if (loggedUser.isEmailVerified()) {
                startActivity(new Intent(this, DashboardFeridActivity.class));
                finish();
            } else {
